 ...
 * With this interface you define a class for automatich store yml data.
 * You only need to specify what data stored in what node of the yml
 * - for store in file
 * - for read from file
 * 
 * the  process is defined as:
 * - read the list of data object, read the whole datafile, but return only list of refId, so you can iterate in a list of id. the id value is your choice but remember it must unique-
