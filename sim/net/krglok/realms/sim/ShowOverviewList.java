...
public class ShowOverviewList extends JDialog
{
	...
	public static void showMe(Object[][] data, Class[] colTypes, String[] header, String titel)
	{
		try
		{
			...
			ShowOverviewList dialog = new ShowOverviewList();
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						ShowOverviewList.this.dispose();
					}
				});
				okButton.setIcon(new ImageIcon(ShowOverviewList.class.getResource("/net/krglok/realms/gui/delete.png")));
