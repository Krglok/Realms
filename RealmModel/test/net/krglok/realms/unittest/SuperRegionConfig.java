...
public class SuperRegionConfig
{
    ...
    public SuperRegionConfig()
    {
        ...
        this.charter = 0;
        this.exp = 0.0;
        this.centralStructure = "";
        this.description = "";
        this.population = 0;
    }
    
    public SuperRegionConfig(String name, List<String> effects, int radius, Map<String, Integer> requirements, double moneyRequirement, double output,
